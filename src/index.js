...
export default class extends Component {
  ...
  static propTypes = {
    ...
    decelerationRate: PropTypes.oneOfType([PropTypes.number, PropTypes.oneOf(['fast', 'normal'])]),
  };
  ...
  scrollBy = (index, animated = true) => {
    ...
    if (state.dir === 'y') y = diff * state.height - this.internals.adjacentViewDiffWidth;
  ...
  render() {
    ...
    let pages = [];
    let paddingHorizontal = horizontal && showAdjacentViews ? adjacentViewsPadding : 0;
    let paddingVertical = !horizontal && showAdjacentViews ? adjacentViewsPadding : 0;

    const pageStyle = [{ width: width, height, paddingHorizontal, paddingVertical }, styles.slide];
